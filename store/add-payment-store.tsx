...
const useAddPaymentStoreBase = createWithEqualityFn<State & Action>(
  (set) => ({
    ...initialState,
...
const useAddPaymentStore = createSelectors(useAddPaymentStoreBase);

export default useAddPaymentStore;
